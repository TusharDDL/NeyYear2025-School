  ...
  it("renders book catalog", async () => {
    ...
    await waitFor(
      () => {
        ...
        expect(
          typeof fetchUrl === "string" && fetchUrl.includes("/api/books"),
        ).toBeTruthy();
      },
      { timeout: 5000 },
    );
      ...
      () => {
        ...
        expect(
          typeof fetchUrl === "string" &&
            fetchUrl.includes("/api/books/circulation"),
        ).toBeTruthy();
      },
      { timeout: 5000 },
    );
    ...
    await waitFor(
      () => {
        ...
        const dataRows = tbody
          ? within(tbody as HTMLElement).getAllByRole("row")
          : [];
        ...
        expect(
          within(circulationRow).getByText("Test Book"),
        ).toBeInTheDocument();
        expect(
          within(circulationRow).getByText(/john smith/i),
        ).toBeInTheDocument();

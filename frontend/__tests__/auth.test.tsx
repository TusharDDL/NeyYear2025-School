...
// Import types
import type { LoginData, RegisterData, LoginResponse, RegisterResponse, ApiError } from '@/types/api'
...
describe('RegisterForm', () => {
  ...
  it('handles successful registration', async () => {
    ...
    mockRegister.mockImplementationOnce(() => Promise.resolve(mockRegisterResponse));
    ...
    await waitFor(async () => {
      ...
      const studentOption = options.find(option => option.textContent?.toLowerCase().includes('student'));
  ...
  it('handles registration error', async () => {
    ...
    const studentOption = await screen.findByRole('option', { name: /student/i });
    await user.click(studentOption);

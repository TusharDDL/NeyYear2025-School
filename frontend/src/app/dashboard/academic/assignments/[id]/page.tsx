...
import { Download, Eye, FileText, CheckCircle, XCircle, Clock } from 'lucide-react';
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-500">Maximum Marks: {assignment?.max_marks}</p>
            </div>
          </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      {submission.status === 'submitted' && (
                        <Button variant="ghost" size="sm" onClick={() => handleGrade(submission)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="number" min="0" max={assignment?.max_marks} />
                    </FormControl>
                    <FormDescription>Maximum marks: {assignment?.max_marks}</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />

        ...
        <div className="flex gap-2">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                <DialogTitle>{selectedCurriculum ? 'Edit' : 'Add'} Curriculum</DialogTitle>
                <DialogDescription>Create or modify curriculum details</DialogDescription>
              </DialogHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          List any required textbooks, materials, or online resources
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <TableRow key={curriculum.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="sm" onClick={() => handleEdit(curriculum)}>
                        <FileEdit className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="sm" onClick={() => handleDelete(curriculum.id)}>

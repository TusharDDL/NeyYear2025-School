    ...
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500">Create and manage lesson plans</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>{selectedLesson ? 'Edit' : 'Add'} Lesson Plan</DialogTitle>
              <DialogDescription>Create or modify lesson plan details</DialogDescription>
            </DialogHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>List any required materials or resources</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Specify any homework assignments</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
            ...
            <TableBody>
              {lessonsData?.map(lesson => (
                <TableRow key={lesson.id}>
                  <TableCell>{format(new Date(lesson.date), 'PPP')}</TableCell>

  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Manage library resources and circulation</p>
      </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium">
                      ...
                      {activity.type === 'new' && (
                        <>
                          Added {activity.quantity} copies of {activity.book}
                        </>
                      )}
                      {activity.type === 'overdue' && (
                        <>
                          {activity.book} is overdue by {activity.student}
                        </>
                      )}
                    </p>
              ...
              {[
                ...
                <div key={index} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium">{book.issued} times issued</p>
                    <p className="text-sm text-gray-500">{book.available} copies available</p>
                  </div>
                </div>
              ))}
            </div>

...
export default function StaffAttendancePage() {
  ...
  const stats = attendanceData?.reduce(
    (acc, record) => {
      ...
      if (record.overtime_minutes > 0) acc.totalOvertimeMinutes += record.overtime_minutes;
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold mt-1">
            {(stats?.present || 0) + (stats?.absent || 0) + (stats?.late || 0)}
          </p>
        </Card>
        ...
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold text-yellow-600 mt-1">{stats?.late || 0}</p>
        </Card>
            ...
            <TableBody>
              {attendanceData?.map(record => (
                <TableRow key={record.id}>
                  ...
                  <TableCell>
                    {record.overtime_minutes > 0 ? `${record.overtime_minutes} mins` : '-'}
                  </TableCell>

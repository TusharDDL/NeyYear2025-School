  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card className="p-6">
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={attendanceData?.[0]?.monthly_breakdown || []}>
        ...
        <Card className="p-6">
          <h2 className="text-lg font-semibold mb-4">Present vs Absent Days</h2>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
      ...
      {/* Detailed Table */}
      {attendanceData && <AttendanceDetails data={attendanceData} />}
    </div>
  );
}
